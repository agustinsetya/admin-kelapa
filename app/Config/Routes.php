...
$routes->group('supply-chain', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('pacak-mesin', 'SupplyChainController::showDataPacakMesin', ['as' => 'supply-pacak-mesin']);
    $routes->get('pacak-mesin/data', 'SupplyChainController::getDataPacakMesin', ['as' => 'supply-data-pacak-mesin']);
    $routes->get('pacak-mesin/detail', 'SupplyChainController::getDetailPacakMesin', ['as' => 'supply-detail-pacak-mesin']);
    $routes->post('pacak-mesin/add', 'SupplyChainController::addDetailPacakMesin', ['as' => 'supply-add-pacak-mesin']);
    $routes->patch('pacak-mesin/update', 'SupplyChainController::updateDetailPacakMesin', ['as' => 'supply-update-pacak-mesin']);
    $routes->delete('pacak-mesin/delete/(:num)', 'SupplyChainController::deleteDetailPacakMesin/$1', ['as' => 'supply-delete-pacak-mesin']);
...
$routes->group('finance', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('kasbon/detail/(:num)', 'FinanceController::showDataDetailKasbon/$1', ['as' => 'finance-detail-kasbon']);
    $routes->get('kasbon/data', 'FinanceController::getDataKasbon', ['as' => 'finance-data-kasbon']);
    $routes->get('kasbon/detail/data', 'FinanceController::getDetailKasbon', ['as' => 'finance-data-detail-kasbon']);
    $routes->post('kasbon/add', 'FinanceController::addDetailKasbon', ['as' => 'finance-add-kasbon']);
    $routes->get('gaji-pacak-mesin', 'FinanceController::showDataGajiPacakMesin', ['as' => 'finance-gaji-pacak-mesin']);
    $routes->get('gaji-pacak-mesin/data', 'FinanceController::getDataUpahPacakMesin', ['as' => 'finance-data-gaji-pacak-mesin']);
    $routes->post('gaji-pacak-mesin/add', 'FinanceController::addDetailGajiPacakMesin', ['as' => 'finance-add-gaji-pacak-mesin']);
...
$routes->group('report', ['filter' => ['auth', 'role:1']], function ($routes) {
    ...
    $routes->get('gaji-pacak-mesin', 'ReportController::showReportGajiPacakMesin', ['as' => 'report-gaji-pacak-mesin']);
    $routes->get('gaji-pacak-mesin/data', 'ReportController::getReportGajiPacakMesin', ['as' => 'report-data-gaji-pacak-mesin']);
