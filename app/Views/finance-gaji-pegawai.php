<?= $this->include('partials/main') ?>
    ...
    <?= $this->include('partials/body') ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                            ...
                                            <div class="col-md-6">
                                                <form id="filter-gaji-pegawai-form" class="row g-2 align-items-end mb-0">
                                                    ...
                                                    <div class="col-12 col-md-4 d-flex gap-2 mt-3 mt-md-0">
                                                        <button type="button" id="applyGajiPegawaiFilter" class="btn btn-primary w-100 text-nowrap">
                                                            <i class="bx bx-filter"></i> Apply Filter
                                                        </button>
                                                        <button type="button" id="resetGajiPegawaiFilter" class="btn btn-light w-100 text-nowrap">Reset</button>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap w-100 dt-gajiPegawaiTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Periode</th>
        ...
        <script src="<?= base_url('assets/js/content/finance-gaji-pegawai.js') ?>"></script>
    </body>
</html>