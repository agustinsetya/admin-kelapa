                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                        ...
                                        <div class="row align-items-end g-2">
                                            <div class="mt-2">
                                                <div class="d-flex justify-content-md-end">
                                                    <button type="button"
                                                            id="btn-tambah-kategori-pengeluaran"
                                                            class="btn btn-success text-nowrap w-100 w-md-auto"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#addKategoriPengeluaranModal">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap w-100 dt-kategoriPengeluaranTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Nama Kategori</th>
