<?= $this->include('partials/main') ?>
    ...
    <?= $this->include('partials/body') ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                            ...
                                            <div class="mt-2">
                                                <div class="d-flex justify-content-md-end">
                                                    <button type="button"
                                                            ...
                                                            data-bs-target="#supplyPenjualanModal">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap w-100 dt-penjualanTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Tanggal Penjualan</th>
                                                    <th>Nama Gudang</th>
                                                    <th>Daging Diterima</th>
                                                    <th>Daging Ditolak</th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
                                    ...
                                    <!-- Include the modal -->
                                    <?= $this->include('modals/supply-penjualan-modal') ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="<?= base_url('assets/js/content/supply-data-penjualan.js') ?>"></script>
    </body>
</html>