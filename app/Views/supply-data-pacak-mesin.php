<?= $this->include('partials/main') ?>
    ...
    <?= $this->include('partials/body') ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                        ...
                                        <div class="row align-items-end g-2">
                                            <div class="mt-2">
                                                <div class="d-flex justify-content-md-end">
                                                    <button type="button"
                                                            id="btn-tambah-pacak-mesin"
                                                            class="btn btn-success text-nowrap w-100 w-md-auto"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#supplyPacakMesinModal">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap w-100 dt-pacakMesinTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Tanggal Pacak Mesin</th>
                                                    <th>Nama Gudang</th>
                                                    <th>Nama Pegawai</th>
                                                    <th>Jumlah Kelapa (Buah)</th>
                                                    <th>Bonus</th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                    ...
                                    <!-- Include the modal -->
                                    <?= $this->include('modals/supply-pacak-mesin-modal') ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="<?= base_url('assets/js/content/supply-data-pacak-mesin.js') ?>"></script>
    </body>
</html>