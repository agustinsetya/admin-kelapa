<?= $this->include('partials/main') ?>
    ...
    <?= $this->include('partials/body') ?>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-end g-2">
                                            <div class="col-md-6">
                                                <form id="filter-finance-gaji-pacak-mesin-form" class="row g-2 align-items-end mb-0">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-12 col-md-4 d-flex gap-2 mt-3 mt-md-0">
                                                        <button type="button" id="applyGajiPacakMesinFilter" class="btn btn-primary w-100 text-nowrap">
                                                            <i class="bx bx-filter"></i> Apply Filter
                                                        </button>
                                                        <button type="button" id="resetGajiPacakMesinFilter" class="btn btn-light w-100 text-nowrap">Reset</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6 mt-2 mt-md-0">
                                                <div class="row justify-content-md-end">
                                                    <div class="col-12 col-md-auto">
                                                        <button type="button"
                                                                id="btn-proses-gaji-pacak-mesin"
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered dt-responsive nowrap w-100 dt-gajiPacakMesinTable">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Periode</th>
                                                    <th>Nama</th>
                                                    <th>Total Upah Pacak Mesin</th>
                                                    <th>Bonus</th>
                                                    <th>Gaji Bersih</th>
                                                    <th>Action</th>
                                                </tr>
        ...
        <script src="<?= base_url('assets/js/content/finance-gaji-pacak-mesin.js') ?>"></script>
    </body>
</html>