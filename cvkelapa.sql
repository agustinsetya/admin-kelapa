...
--
-- Table structure for table `mt_bonus`
--

CREATE TABLE `mt_bonus` (
  `mt_bonus_id` int(10) NOT NULL,
...
--
-- Table structure for table `mt_gaji`
--

CREATE TABLE `mt_gaji` (
  ...
  `status_pembayaran` enum('BELUM_BAYAR','PENDING','DIBAYAR','GAGAL') NOT NULL DEFAULT 'BELUM_BAYAR',
  `tg_pembayaran` date DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `created_by` varchar(100) NOT NULL,
...
INSERT INTO `mt_pengolahan` (`mt_pengolahan_id`, `tg_pengolahan`, `gudang_id`, `kd_pegawai`, `berat_daging`, `berat_kopra`, `bonus`, `is_stat_gaji`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(3, '2025-08-26', 1, '9000000123', 250, 500, 0, 0, '2025-08-28 18:12:38', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(4, '2025-08-19', 4, '9000000586', 200, 482, 0, 0, '2025-08-28 18:12:38', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(5, '2025-08-20', 1, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(6, '2025-08-20', 4, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(7, '2025-08-12', 1, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(8, '2025-08-14', 4, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(9, '2025-08-14', 1, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(10, '2025-08-06', 4, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(11, '2025-08-07', 2, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(12, '2025-08-12', 3, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:16:09', ''),
(13, '2025-08-28', 4, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:14:06', ''),
(14, '2025-08-28', 3, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:06', 'agustin@gmail.com', '2025-08-28 18:14:06', ''),
(15, '2025-08-28', 6, '9000000123', 250, 500, 0, 0, '2025-08-28 18:14:55', 'agustin@gmail.com', '2025-08-28 18:14:55', ''),
(16, '2025-08-28', 4, '9000000586', 200, 482, 0, 0, '2025-08-28 18:14:55', 'agustin@gmail.com', '2025-08-28 18:14:55', '');
...
(3, '9000000123', 'riansss@gmail.com', '$2y$10$B./3eC7OvNIFPjuwo9e4vOghOECN336caeXDX2PcaxBuUgHBSzWzm', '2025-08-31 02:24:08', '2025-08-31 02:24:08');
...
--
-- Indexes for table `mt_bonus`
--
ALTER TABLE `mt_bonus`
  ADD PRIMARY KEY (`mt_bonus_id`),
  ADD KEY `fk_bonus_pegawai` (`kd_pegawai`);

--
-- Indexes for table `mt_gaji`
--
ALTER TABLE `mt_gaji`
  ADD PRIMARY KEY (`mt_gaji_id`),
...
--
-- AUTO_INCREMENT for table `mt_bonus`
--
ALTER TABLE `mt_bonus`
  MODIFY `mt_bonus_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mt_user`
  MODIFY `mt_user_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Constraints for table `mt_bonus`
--
ALTER TABLE `mt_bonus`
  ADD CONSTRAINT `fk_bonus_pegawai` FOREIGN KEY (`kd_pegawai`) REFERENCES `mt_pegawai` (`kd_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `mt_gaji`
--
ALTER TABLE `mt_gaji`
  ADD CONSTRAINT `fk_gaji_pegawai` FOREIGN KEY (`kd_pegawai`) REFERENCES `mt_pegawai` (`kd_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;
